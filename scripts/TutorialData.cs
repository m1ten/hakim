...
public static class TutorialData
{
    public static readonly string[] DayMessages =
    {
        ...
        "Day 3: Renaissance brings new trade routes and diseases. Check merchants and artists carefully.",
        "Day 4: Industrial diseases are common. Look for respiratory issues in factory workers.",
